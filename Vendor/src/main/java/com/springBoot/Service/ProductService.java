...
public class ProductService {
    ...
    public int save(Product p) {
        String sql = "insert into products(Name, Price, Category, Description, ImageURL) values(?, ?, ?, ?, ?)";
        return template.update(sql, p.getName(), p.getPrice(), p.getCategory(), p.getDescription(), p.getImageURL());
